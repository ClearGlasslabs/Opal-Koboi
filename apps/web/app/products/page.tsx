...
export default function ProductsPage() {
  ...
  return <main className="productsShell">
    <nav className="productsNav"><a href="/" className="productsBrand"><b>A</b><span>CLEARGLASSINC<small>ARTEMIS / PRODUCT INTELLIGENCE</small></span></a><a href="/#platform-promise">Platform</a><a href="https://www.clearglassinc.com/#contact">Secure briefing ↗</a></nav>
